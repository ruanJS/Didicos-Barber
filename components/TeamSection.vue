    ...
    <div class="container mx-auto px-4 lg:px-48">
      ...
      <div class="flex gap-10 items-start">
        ...
        <UButton
          ...
          variant="ghost"
          color="gray"
          class="absolute left-4 top-1/2 -translate-y-12 z-5 bg-white/70 hover:bg-white text-black rounded-full w-12 h-12 shadow-md flex items-center justify-center cursor-pointer"
          @click="scrollLeft"
        >
        ...
        <UButton
          ...
          variant="ghost"
          color="gray"
          class="absolute right-5 top-1/2 -translate-y-12 z-5 bg-white/70 hover:bg-white text-black rounded-full w-12 h-12 shadow-md flex items-center justify-center cursor-pointer"
          @click="scrollRight"
        >
